...
![git-lfs](https://git-lfs.github.com/images/graphic.gif)
...
- 通过[官方地址](https://github.com/git-lfs/git-lfs/releases/)下载 Git LFS 安装包 [Windows Installer](https://github.com/git-lfs/git-lfs/releases/download/v2.9.2/git-lfs-windows-v2.9.2.exe).
- 双击安装包，打开安装 git-lfs
